    ...
    <main className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://maps.google.com/?q=Av.Capdevila+2147" target="_blank" rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#8B5CF6]/10 border border-[#8B5CF6]/30 mb-8">
                ...
                <span className="text-sm font-semibold text-[#CCFF00] uppercase tracking-wider">DESCUBRÍ TU ENERGÍA</span>
              </div>
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.9] mb-6 uppercase"
                style={{ fontFamily: 'var(--font-bebas)', letterSpacing: '0.02em' }}>
                <span className="text-foreground">SENTIRTE</span><br />
                <span className="text-[#CCFF00]" style={{ textShadow: '0 0 30px rgba(200,255,0,0.4)' }}>MEJOR QUE NUNCA</span><br />
      ...
      <section className="relative py-28 md:py-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <p
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase leading-tight"
            style={{ fontFamily: 'var(--font-bebas)', letterSpacing: '0.03em' }}
          >
            <span className="text-[#8B5CF6]">{'"'}SOMOS FAMILIA</span>
            <br />
            <span className="text-[#CCFF00]" style={{ textShadow: '0 0 30px rgba(200,255,0,0.5)' }}>SOMOS ENERGÍA{'"'}</span>
          </p>
